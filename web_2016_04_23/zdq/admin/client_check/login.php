...
if (isset($_POST['username'])) {
  ...
  if ($loginFoundUser) {
	...
	if($_SESSION['zdq_admin_group']==0&&$_SESSION['zdq_admin_group']!=NULL){
...
<?php
	...
	echo "<p style='text-align:center;'>点击“跳转”登录<a href='index.php'>跳转</a><br/>";
?>
