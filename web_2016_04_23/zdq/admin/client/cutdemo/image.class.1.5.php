...
class Images{
    ...
    function thumb($image,$is_save=true,$suofang=0,$type='',$maxWidth=600,$maxHeight=400,$interlace=true){/*比例：1*/
        // 获取原图信息
       $info  = $this->getImageInfo($image);
         if($info !== false) {
            ...
            if ($suofang==1) {
                ...
                $thumbImg01 = imagecreatetruecolor(300,200);/*比例：2*/
                imagecopyresampled($thumbImg01,$thumbImg,0,0,$_POST['x'],$_POST['y'],300,200,$_POST['w'],$_POST['h']);/*比例：3*/

				$thumbImg02 = imagecreatetruecolor(120,80);/*比例：4*/
                imagecopyresampled($thumbImg02,$thumbImg,0,0,$_POST['x'],$_POST['y'],120,80,$_POST['w'],$_POST['h']);/*比例：5*/
